...
To chyba najczęstszy błąd. Jest on powiązany z użyciem **odpowiednich tagów HTML**, o których mówiłem również w poprzednim wpisie - [Dostępność - projektowanie i semantyczny HTML](https://frontlive.pl/blog/dostepnosc-semantyczny-html).
